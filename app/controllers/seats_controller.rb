class SeatsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @seat.save
		format.html { render :partial => 'flights/seat_list', :locals => {:seats =>  @seat.flight.seats}, notice: 'Seat was successfully created.' }
      else
        format.html { render :new, notice: 'Sorry - the seat could not be booked.' }
		format.json { render json: @seat.errors, status: :unprocessable_entity }
      end
